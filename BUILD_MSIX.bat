...
title wexporting - MSIX Builder

set "APP_ROOT=%~dp0"
set "VENV_PY=%APP_ROOT%imgapp_venv\Scripts\python.exe"
set "BUILD_SCRIPT=%APP_ROOT%build\scripts\build_msix.py"

echo.
echo ================================================
echo   wexporting MSIX Builder
echo ================================================
echo.
...
rem Optional version override via argument: BUILD_MSIX.bat 1.0.5.0
if not "%~1"=="" (
    set "BUILD_VERSION=%~1"
