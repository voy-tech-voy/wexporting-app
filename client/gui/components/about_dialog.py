...
def show_about_dialog(parent, theme_manager):
    ...
    <br>
    <p style="color: {text_color}; font-size: 16px; font-weight: bold;"><span style="font-family: 'Segoe UI Emoji', sans-serif;">🌐</span> <a href="https://wexporting.com" style="color: {accent_color}; text-decoration: none;">Visit our website</a></p>
    <br>
    <p style="color: {text_color};">This software uses FFmpeg (© FFmpeg developers) licensed under the LGPL/GPL.</p>
    <p style="color: {text_color};">© 2026 {AUTHOR}. All rights reserved.</p>
    """
