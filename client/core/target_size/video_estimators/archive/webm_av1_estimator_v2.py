...
class Estimator(EstimatorProtocol):
    ...
    def description(self) -> str:
        return "AV1 2-pass CBR encoding (80% more efficient, slowest)"
    ...
    def estimate(
        ...
        **options
        ...
        print(f"[AV1_v2] Estimating for {target_size_bytes} bytes, downscale={allow_downscale}")
        ...
        print(f"[AV1_v2] Estimated: {int(vid_bps/1000)}kbps, {curr_w}x{int(meta['height'] * (curr_w / meta['width'])) & ~1}")
