...
class Estimator(EstimatorProtocol):
    ...
    def description(self) -> str:
        return "H.264 2-pass CBR (interruptible)"
    ...
    def estimate(
        ...
        **options
        ...
        print(f"[H264_v3] Estimating for {target_size_bytes} bytes, downscale={allow_downscale}")
        ...
        print(f"[H264_v3] Estimated: {int(vid_bps/1000)}kbps, {curr_w}x{int(meta['height'] * (curr_w / meta['width'])) & ~1}")
    ...
    def execute(
        ...
        **options
        ...
        """Execute 2-pass CBR encoding for H.264 with proper interruptibility."""
        import threading
        import subprocess
